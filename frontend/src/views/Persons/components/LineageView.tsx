...
const LineageView: React.FC<LineageViewProps> = ({ persons, spouses, parentChilds }) => {
    ...
    return (
        <div className="flex h-full bg-gray-50 w-full">
            ...
            <aside className="w-16 md:w-48 flex-shrink-0 border-r border-gray-200 bg-white overflow-y-auto flex flex-col items-center md:items-start md:pl-4 py-4 gap-3 select-none transition-all duration-300">
